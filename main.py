...
word = "python is cool and stuff but fortnite better"  #string variable
#(print word)
...
print(word[-2])
print(word[-3])
print(word[7:9])#this is called string index 
print(word[15:18])
print(word[ :-1])
print(len(word))#gives you the length of the entire sting 
print(word[:13])
print(word[5:])
#what if I wanted to find a substring?
# a substring is just like a regular word inside of a sentence 
print(word.find("is"))#finds the index of a substring
print(word.find("and"))
print(word.upper())
